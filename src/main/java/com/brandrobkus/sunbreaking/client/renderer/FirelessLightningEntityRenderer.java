...
public class FirelessLightningEntityRenderer extends EntityRenderer<FirelessLightningEntity> {
    public FirelessLightningEntityRenderer(EntityRendererFactory.Context context) {
        super(context);
    }

    public void render(FirelessLightningEntity lightningEntity, float f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
    ...
    @Override
    public Identifier getTexture(FirelessLightningEntity entity) {
        return null;
    }
