...
public class SkyFirelessLightningRenderer extends EntityRenderer<SkyFirelessLightningEntity> {
    public SkyFirelessLightningRenderer(EntityRendererFactory.Context context) {
        super(context);
    }

    public void render(SkyFirelessLightningEntity lightningEntity, float f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
    ...
    @Override
    public Identifier getTexture(SkyFirelessLightningEntity entity) {
        return null;
    }
